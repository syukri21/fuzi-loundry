...
class C_Order extends CI_Controller
{
	...
	{
		$this->db->where('order_id', $this->input->post('order_id'));
		if ($this->db->update('order', ['status_order' => 'selesai_cuci', 'date' => date('Y-m-d h:i:s')])) {
			echo json_encode(['status' => true]);
		} else {
			echo json_encode(['status' => false]);
		}
	...
	{
		$this->db->where('order_id', $this->input->post('order_id'));
		if ($this->db->update('order', ['status_order' => 'pengantaran', 'date' => date('Y-m-d h:i:s')])) {
			echo json_encode(['status' => true]);
		} else {
			echo json_encode(['status' => false]);
		}
	...
	{
		$this->db->where('order_id', $this->input->post('order_id'));
		if ($this->db->update('order', ['status_order' => 'selesai_pengantaran', 'date' => date('Y-m-d h:i:s')])) {
			echo json_encode(['status' => true]);
		} else {
			echo json_encode(['status' => false]);
		}
