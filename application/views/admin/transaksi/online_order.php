...
<body>
	...
	<script type="text/javascript">
		...
		function loadSudahBayar() {
			$.ajax({
				url: base_url + 'getOrderByStatusTransaksi/settlement/online',
				type: 'get',
				dataType: 'json',
				beforeSend: function() {
                ...
                <tr>
                  ...
                  <td align="center">
                    <button class="btn btn-primary" onclick="openEdit(${resOrder.id}, ${resOrder.id_pelanggan}, ${resOrder.berat}, ${resOrder.harga}, ${resOrder.total_harga})"><i class="fa fa-pencil"></i></button>
		...
		function openEdit(id, id_pelanggan, berat, harga, total_harga) {
			$("#id_edit").val(id)
		...
		function loadBelumBayar() {
			$.ajax({
				url: base_url + 'getOrderByStatusTransaksi/belum_bayar/online',
				type: 'get',
				dataType: 'json',
				beforeSend: function() {
		...
		$("#berat_e").keyup(function() {
			var harga = parseInt($('#berat_e').val()) * parseInt($('#harga').val())
