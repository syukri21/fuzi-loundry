        ...
        <li class="onhover-dropdown">
          ...
          <ul class="notification-dropdown onhover-show-div">
            ...
            <?php foreach ($notif->result() as $key => $value): ?>
              <li>
                <p><i class="fa fa-circle-o me-3 font-danger"></i><?php echo $value->nama_pelanggan; ?> <span class="pull-right"><?php echo $value->order_id; ?></span></p>
              </li> 
            <?php endforeach ?>
            <?php if($notif->num_rows() == 0) { ?>
              <li>
                <p>Tidak ada orderan hari ini</p>
              </li>
            <?php } ?>
            <li>
              <a href="<?php echo base_url('kurir-order'); ?>" class="btn btn-secondary">Data Order</a>
            </li> 
          </ul>
        </li>
        <li>
